...
export const metadata: Metadata = buildMetadata({ title: "Free Academic and Graduate CV Builder", description: "Create a clear academic, graduate, or early-career CV with a guided WriteX planning tool.", path: "/tools/cv-builder" });
