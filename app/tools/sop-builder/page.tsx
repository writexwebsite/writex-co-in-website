...
export const metadata: Metadata = buildMetadata({ title: "Free SOP Planning Framework Builder", description: "Plan an evidence-led SOP framework with prompts for programme fit, academic motivation, profile evidence, and career direction from WriteX.", path: "/tools/sop-builder" });
