...
export const metadata: Metadata = buildMetadata({ title: "Free Academic and Admissions Planning Tools", description: "Create a clearer starting point with guided CV, SOP, and academic planning tools from WriteX.", path: "/tools" });
