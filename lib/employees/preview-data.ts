...
export const employeePreviewTeams: EmployeeTeam[] = [
  ...
  { id: deliveryTeamId, teamCode: "DEV-OPS", name: "Development / Operations", department: "Development / Operations", status: "ACTIVE", employeeCount: 6 },
...
function previewEmployee(overrides: Partial<EmployeeDirectoryItem> & Pick<EmployeeDirectoryItem, "id" | "employeeCode" | "displayName" | "officialEmail">): EmployeeDirectoryItem {
  return {
    ...
    deliveryHierarchyAttention: null,
    learningAssignmentId: null,
    learningPathKey: null,
    learningPathTitle: null,
    learningAssignmentStatus: "NOT_ASSIGNED",
    learningAssignedAt: null,
    learningFirstLessonRoute: null,
    syncStatus: "SYNCED",
...
const ids = {
  ...
  deliveryTeamManager: "20000000-0000-4000-8000-000000000006",
  deliveryTeamLeader: "20000000-0000-4000-8000-000000000007",
  deliveryTrainer: "20000000-0000-4000-8000-000000000008",
  seniorSme: "20000000-0000-4000-8000-000000000009",
  juniorSme: "20000000-0000-4000-8000-000000000010",
  inactive: "20000000-0000-4000-8000-000000000011",
  archived: "20000000-0000-4000-8000-000000000012"
} as const;
...
export const employeePreviewItems: EmployeeDirectoryItem[] = [
  ...
  previewEmployee({ id: ids.deliveryTeamManager, employeeCode: "WX-DEV-002", displayName: "Mira Iyer", officialEmail: "mira.iyer@example.test", department: "Development / Operations", designation: "Team Manager", primaryTeamId: deliveryTeamId, teamName: "Development / Operations", academyArea: "DEVELOPMENT_OPERATIONS", deliveryOperationalRole: "TEAM_MANAGER", deliveryReportingParentEmployeeId: ids.deliveryManager, deliveryReportingParentName: "Devika Rao" }),
  previewEmployee({ id: ids.deliveryTeamLeader, employeeCode: "WX-DEV-003", displayName: "Nikhil Shah", officialEmail: "nikhil.shah@example.test", department: "Development / Operations", designation: "Team Leader", primaryTeamId: deliveryTeamId, teamName: "Development / Operations", academyArea: "DEVELOPMENT_OPERATIONS", deliveryOperationalRole: "TEAM_LEADER", deliveryReportingParentEmployeeId: ids.deliveryTeamManager, deliveryReportingParentName: "Mira Iyer" }),
  previewEmployee({ id: ids.deliveryTrainer, employeeCode: "WX-DEV-004", displayName: "Farah Khan", officialEmail: "farah.khan@example.test", department: "Development / Operations", designation: "Delivery Trainer", primaryTeamId: deliveryTeamId, teamName: "Development / Operations", academyArea: "DEVELOPMENT_OPERATIONS", academyRole: "TRAINER" }),
  previewEmployee({ id: ids.seniorSme, employeeCode: "WX-DEV-005", displayName: "Arjun Mehta", officialEmail: "arjun.mehta@example.test", department: "Development / Operations", designation: "Senior Subject Matter Expert", primaryTeamId: deliveryTeamId, teamName: "Development / Operations", academyArea: "DEVELOPMENT_OPERATIONS", deliveryOperationalRole: "SENIOR_SME", deliveryReportingParentEmployeeId: ids.deliveryTeamLeader, deliveryReportingParentName: "Nikhil Shah", deliveryTrainerEmployeeId: ids.deliveryTrainer, deliveryTrainerName: "Farah Khan", learningAssignmentId: "30000000-0000-4000-8000-000000000001", learningPathKey: "DELIVERY_CORE", learningPathTitle: "Development Academy Core Learning Path", learningAssignmentStatus: "ACTIVE", learningAssignedAt: "2026-08-25T09:00:00.000Z", learningFirstLessonRoute: "/delivery/learn/core/1" }),
  previewEmployee({ id: ids.juniorSme, employeeCode: "WX-DEV-006", displayName: "Ishita Roy", officialEmail: "ishita.roy@example.test", department: "Development / Operations", designation: "Junior Subject Matter Expert", primaryTeamId: deliveryTeamId, teamName: "Development / Operations", academyArea: "DEVELOPMENT_OPERATIONS", deliveryOperationalRole: "JUNIOR_SME", deliveryReportingParentEmployeeId: ids.deliveryTeamLeader, deliveryReportingParentName: "Nikhil Shah", deliveryTrainerEmployeeId: ids.deliveryTrainer, deliveryTrainerName: "Farah Khan" }),
