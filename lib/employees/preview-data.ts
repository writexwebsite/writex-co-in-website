...
export const employeePreviewItems: EmployeeDirectoryItem[] = [
  ...
  previewEmployee({ id: ids.seniorSme, employeeCode: "WX-DEV-005", displayName: "Arjun Mehta", officialEmail: "arjun.mehta@example.test", department: "Development / Operations", designation: "Senior Subject Matter Expert", primaryTeamId: deliveryTeamId, teamName: "Development / Operations", academyArea: "DEVELOPMENT_OPERATIONS", deliveryOperationalRole: "SENIOR_SME", deliveryReportingParentEmployeeId: ids.deliveryTeamLeader, deliveryReportingParentName: "Nikhil Shah", deliveryTrainerEmployeeId: ids.deliveryTrainer, deliveryTrainerName: "Farah Khan", learningAssignmentId: "30000000-0000-4000-8000-000000000001", learningPathKey: "DELIVERY_CORE", learningPathTitle: "Delivery Core Learning Path", learningAssignmentStatus: "ACTIVE", learningAssignedAt: "2026-08-25T09:00:00.000Z", learningFirstLessonRoute: "/delivery/learn/core/1" }),
