...
const safeError =
  "We could not verify those details. Please check the invoice number and registered mobile number or contact WriteX.";
...
export function ClientLoginForm() {
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    navigateWithAxoTransition("/client/overview", router.push);
  }
  ...
  return (
    <form className="wx-auth-form" onSubmit={handleSubmit} aria-busy={isSubmitting}>
      ...
      <div className="mt-7">
        <AuthInput label="Invoice Number" icon={ReceiptText} id="auth-first-input" name="invoiceId" required minLength={3} autoComplete="off" aria-describedby={message ? "client-login-error" : undefined} placeholder="Enter your invoice number" />
      </div>
